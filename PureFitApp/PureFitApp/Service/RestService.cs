...
[assembly: Dependency(typeof(PureFitApp.Service.RestService))]
namespace PureFitApp.Service
{
    /// <summary>
    ...
    public class RestService
    {
        ...
        // abgebildet.
        public Task<IEnumerable<TrainingslevelDto>> GetTrainingslevelsAsync() => SendAsync<IEnumerable<TrainingslevelDto>>(HttpMethod.Get, "fitness/trainingslevel");
        public Task<UserKundenDto> GetKundenData() => SendAsync<UserKundenDto>(HttpMethod.Get, "kunden/getData");
        public Task<IEnumerable<FitnessHistoryDto>> GetFitnessHistoryAsync() => SendAsync<IEnumerable<FitnessHistoryDto>>(HttpMethod.Get, "fitness/getFitnessVerlauf");
        public Task<IEnumerable<FItnessuebungDto>> GetFitnessUebungenAsync() => SendAsync<IEnumerable<FItnessuebungDto>>(HttpMethod.Get, "fitness");
        public Task<FItnessuebungDto> GetUebung(long id) => SendAsync<FItnessuebungDto>(HttpMethod.Get, "fitness", id+"");
        ...
        public async Task<bool> TryLoginAsync(UserDto user)
        {
            try
            {
                UserDto sentUser = await SendAsync<UserDto>(HttpMethod.Post, "user/login2", user);
